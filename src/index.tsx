...
import addOil from "./images/hkaddoil.png";
import vCard from "./StevenChong.vcf";
const vCardContent =
...
const useStyles = makeStyles(theme =>
  createStyles({
    ...
    socialLinks: {
      ...
      "& a": {
        ...
        "&:hover": {
          ...
          textDecoration: "none",
          animation: "$social-links-loop1 3s infinite"
        }
      }
    },
    socialTitle: {
    ...
    "@keyframes social-links-loop1": {
      ...
      "23%": { marginLeft: -8, marginRight: 8 },
      "69%": { marginLeft: 8, marginRight: -8 },
      "92%": { marginLeft: 0, marginRight: 0 }
    },
    "@keyframes bg-loop1": {
      "0%": { opacity: 0.01 },
      "10%": { opacity: 0.01 },
